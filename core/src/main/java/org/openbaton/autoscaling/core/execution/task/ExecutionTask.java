...
public class ExecutionTask implements Runnable {
    ...
    public ExecutionTask(String projectId, String nsr_id, Map actionVnfrMap, Set<ScalingAction> actions, long cooldown, ExecutionEngine executionEngine, ActionMonitor actionMonitor, NfvoProperties nfvoProperties) {
...
//        }
        try {
            for (ScalingAction action : actions) {
                vnfr = nfvoRequestor.getNetworkServiceRecordAgent().getVirtualNetworkFunctionRecord(nsr_id, actionVnfrMap.get(action.getId()));
                if (vnfr == null) {
