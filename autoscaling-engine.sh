...
function init {
    if [ ! -f $_config_file ]; then
        if [ $EUID != 0 ]; then
            ...
            sudo -E sh -c "mkdir /etc/openbaton; cp ${_project_base}/src/main/resources/openbaton-ase.properties ${_config_file}"
            ...
            cp ${_project_base}/src/main/resources/openbaton-ase.properties ${_config_file}
        fi
    else
